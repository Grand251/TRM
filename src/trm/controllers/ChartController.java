...
public class ChartController {
	...
	public String chartRequested(HttpServletRequest request, ModelMap model) 
	{
		...
		case "Project Manager":
			return "redirect:/chartRequester";
		case "SPOC":
			return "redirect:/chartspocrequests";
		}
	...
	public String chartRequestForRequester(HttpServletRequest req, ModelMap model) 
	{
		...
		if(req.getParameter("period")!=null) {
			...
			int period = Integer.parseInt(req.getParameter("period"));
			int requesterId = ((Employee)req.getSession().getAttribute("user")).getEmployee_id();
