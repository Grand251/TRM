...
<body>
	...
	<div class="container">
		<form action="addnewrequest" class="form" style="margin-left: 20px;">
			...
			<div class="row">
				...
				<div class="col-xs-10">
					<input id="trainingmodule" type="text" class="form-control"
						name="request_training_module" placeholder="Language(Java,Sql)"
						required>
				</div>
			</div>
			<br>
			...
			<div class="row">
				<div class="col-xs-2">
					<label class="control-label"> Module Scope </label>
				</div>
				<div class="col-xs-10">
					<textarea class="form-control" rows="5" id="comment"
						name="textarea" placeholder="JDBC" required></textarea>
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-xs-10">
					<input class="radio-inline" type="radio" id="mfm" name="online"
						value="Online" checked> <label class="form-check-label"
						for="mfm" name="online">Online</label> <input class="radio-inline"
						type="radio" id="mff" name="online" value="Vendor"> <label
						class="form-check-label" for="mff" name="vendor">Vendor</label>
				</div>
			</div>
			<br>
			<div class="row">
				<div class="col-xs-2">
					<label class="control-label"> Preferred Training Type </label>
				</div>
				<div class="col-xs-10">
					<input class="radio-inline" type="radio" id="abc" name="type"
						value="Internal" checked> <label class="form-check-label"
						for="abc">Internal</label> <input class="radio-inline"
						type="radio" id="def" name="type" value="Vendor"> <label
						class="form-check-label" for="def">Vendor</label> <input
						class="radio-inline" type="radio" id="bcd" name="type"
						value="Dev Team"> <label class="form-check-label"
						for="bcd">Development</label>
			...
			<div class="row">
				<div class="col-xs-2">
					<label class="control-label"> Proposed Start Date/Time </label>
				</div>
				<div class="col-xs-5">
					<input id="training_start" type="date" class="form-control"
						name="training_start" placeholder="Start date">
				</div>
				<div>
					<input id="training_startTime" type="time" class="form-control"
						name="training_startTime" placeholder="Start time" required>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-2">
					<label class="control-label"> Proposed End Date/Time </label>
				</div>
				<div class="col-xs-5">
					<input id="training_end" type="date" class="form-control"
						name="training_end" placeholder="End date">
				</div>
				<div>
					<input id="training_endTime" type="time" class="form-control"
						name="training_endTime" placeholder="Start time" required>
				</div>
			</div>
			<br>
			<div class="row">
				<div class="col-xs-2">
					<label class="control-label"> Enter Time Zone </label>
				</div>
				<div class="col-xs-10">
			...
			<div class="row">
				<div class="col-xs-2">
					<label class="control-label"> Project SPOC </label>
				</div>
				<div class="col-xs-10">
					<input id="spoc" type="number" class="form-control" name="spoc"
						placeholder="SPOC ID" required>
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-xs-10">
					<input id="participants" type="number" class="form-control"
						name="participants" placeholder="Participants number" required>
				</div>
			</div>
			<br>
			<div class="row">
				<div class="col-xs-2">
					<label class="control-label"> Justification of Request: </label>
				</div>
				<div class="col-xs-10">
					<textarea class="form-control" rows="5" id="justification"
						name="justification" placeholder="Reason for request" required></textarea>
				</div>
			</div>
			<br> <br>
			<div class="row">
				<div class="col">
					<div class="text-right">
						<button type="submit" class="btn btn-info">
							Send Request <i class="fa fa-save" aria-hidden="true"></i>
						</button>
					</div>
				</div>
			</div>
	...
	<footer id="footer">
		<div style="margin: 10px 0 0 0" class="row">
			<div class="col-xs-12">
				<p
					style="text-align: center; margin-top: 10px; margin-right: 0; margin-left: 25px">&copy;Copyright
					2017 Syntel INC. All rights reserved.</p>
			</div>
		</div>
	</footer>
</body>
