...
<head>
  ...
  <title>SPOC Dashboard</title>
     ...
     <link rel="stylesheet" href="resources/stylesheets/spoc_dashboard.css">
...
<body>
  ...
  <div class="row" style="height: 65vh;">
    <!--New Request Box-->
    <div id="newRequestBox" class="border" style="border-right: 2px solid black;">
    <form action="selectNewRequest">
      <!--Start Button Send selected new requests to be ongoing requests-->
      <button id="startButton" class="row* sticky-top" style="font-size: 30px; margin-bottom: 50px;" onclick="submitTR()" >
        Process
      ...
      <div class="col">
        ...
        <div class="portfolio-item cardSpacing" style="float:left" >
          <div class="card h-100" id="card" style="margin-top:-15px; background-color: #007bff; color: white;">
            <table>
              <td>
    ...
    <div id="ongoingRequestBox" class="border">
      ...
      <div style="margin-left: 7vw;">
       <c:forEach items="${trList}" var="tr">
        ...
        <!-- 1 card -->
        <div class="portfolio-item cardSpacing" style="float:left">
          <div class="card h-100" id="card" style="border: 10px solid orange;">
            <table>
              <td>
       ...
       <c:forEach items="${itrList}" var="itr">
        <!-- 1 card -->
        <div class="portfolio-item cardSpacing" style="float:left;" >
          <div class="card h-100" id="card" style="border: 10px solid green;">
            <table>
              <td>
