...
<body>
	...
	<div class="container" id="bodycont" style="margin-top: 50px">
		<f:form action="../saveUpdateVendorTrainerData" class="form"
			style="margin-left:20px;width:80%">
			<h3>Edit Vendor Trainer Details</h3>
			<br>
			<br>
			<div class="row" style="align-items: center; display: flex">
				<div class="col-xs-2">
					<label class="control-label"> Vendor Trainer ID </label>
				</div>
				<div class="col-xs-10" style="align-items: center; display: flex">
					<div class="input-group">
						...
						<f:input path="vendor_trainer_id" id="vendor_trainer_id"
							type="number" class="form-control" name="vendor_trainer_id" />
			...
			<div class="row" style="align-items: center; display: flex">
				<div class="col-xs-2">
					<label class="control-label"> Vendor Trainer Name </label>
				</div>
				<div class="col-xs-10">
					<div class="input-group">
						<div class="input-group-prepend">
						...
						<f:input path="vendor_trainer_name" id="vendor_trainer_name"
							type="text" class="form-control" name="vendor_trainer_name" />
			...
			<div class="row" style="align-items: center; display: flex">
				...
				<div class="col-xs-10">
					<div class="input-group">
						...
						<f:input path="profile" type="text" class="form-control"
							name="profile" />
					</div>
				</div>
			</div>
