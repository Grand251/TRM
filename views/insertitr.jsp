...
<f:form action="newitr">
	...
	Status: <f:input path="itrStatus"/><br>
	  
	Trainer Employee ID: <f:select path="itrTrainer">
		<f:options items="${employees}" itemValue="employee_id" itemLabel="employee_id"/>
	</f:select>
		<a href="showallemployees">Employee List</a><br>
	...
	<a href="showalltr">Training Request List</a><br>
	...
	Schedule ID: <f:select path="itrSchedule">
		<f:options items="${schedules}" itemValue="training_schedule_id" itemLabel="training_schedule_id"/>
	</f:select><br>
	
	<a href="showallschedules">Schedule List</a><br>
