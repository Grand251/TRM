...
<body>
		...
		<div class="header-container">
			...
			<div class="left-header">
				<a class="logo-content" href="#" title="Home"> <img
					class="logoimage1" src="resources/img/as-logo.png" alt="Home">
				</a>
			</div>
			<!-- Right-aligned links -->
			<div id="right-header">
				<a href="about.html" class="about">About</a> <a href="#"
					class="logolink" title="Home"> <img class="logoimage2"
					src="resources/img/as-logo.png" alt="Home">
				</a>
			</div>
		</div>
	</div>
			...
			<div class="portfolio-item cardSpacing" style="float: left">
				<div class="card h-100" id="card">
					<table>
						...
						<td>
							<!--card Drop down -->
							<div class="dropdown" align="right" style="margin-top: 0px"
								id="moreInfo">
								...
								<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
									<li><a href="#"><span
											...
											${training.workflow.trainingRequest.requestTrainingModuleScope}
									</a></li>
									<li><a href="#"><span class="glyphicon glyphicon-home"></span>
											${training.workflow.trainingRequest.requestTrainingType}</a></li>
									<!--internal or vender -->
									<li><a href="#"> <span
											class="glyphicon glyphicon-modal-window"></span>
											${training.workflow.trainingRequest.requestTrainingMode}
									</a></li>
									<!--"mode" of training -->
									<li><a href="#"><span>&#35;</span>
											${training.workflow.trainingRequest.approxNumberOfParticipants}
											Participants </a></li>
									<!--Edit button 1 popover-->
									<li>
										<button type="button" class="center-block" data-toggle="modal"
									...
									<li><a href="#"><span
											...
											${training.schedule.training_start_date} </a></li>
									<li><a href="#"><span
											class="glyphicon glyphicon-calendar"></span>
											${training.schedule.training_end_date} </a></li>
									<li><a href="#"><span class="glyphicon glyphicon-time">
										</span>${training.schedule.training_time_zone} </a></li>
									<li><a href="#"><span
											class="glyphicon glyphicon-globe"></span>
											${training.schedule.training_location} </a></li>
									...
									<li role="separator" class="divider"></li>
									<li><a href="#" data-toggle="modal" data-target="#Log"
	...
	<footer id="footer">
		<div class="row*">
			<div class="col-xs-12">
				<p class="m-0" style="text-align: center; margin-top: 15px;">&copy;Copyright
