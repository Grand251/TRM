...
<body>
	...
	<h3>${spoc.getFirst_name()}&nbsp${spoc.getLast_name()}&nbsp &nbsp
	...
	<f:input path="itrId" id="itrId" cssStyle="background-color: #D3D3D3"
			readonly="true" />
		<br>
	Internal Training Status: &nbsp
	<f:input path="itrStatusDescription"
	...
	<f:select path="itrTrainer">
			<c:forEach items="${trainers}" var="trainer">
				<f:option value="${trainer}"
					label="${trainer.employee_id} ${trainer.first_name} ${trainer.last_name }" />
			</c:forEach>
		</f:select>
