  ...
  <div class="container-fluid" style="height: 77vh; overflow: auto;">
    <div class="row">
      <div class="col-sm-4 offset-sm-4">
        <h1 class="text-center">Vendor Details Table</h1>
      </div>
      <div class="col-sm-4" style="position: relative;">
        <a href="insertVendorDetailsForm" data-toggle="tooltip" title="Insert new employee" style="position:absolute; bottom:0; left:65%;">
        ...
        <table class="table border border-dark table-striped">
          ...
          <thead class="thead-dark">
            <tr>
              ...
              <th class="text-center" scope="col">Time Zone</th>
          ...
          <c:forEach items = "${allVendors}" var = "vendorDetails">
            <tr>
              <td class="text-center" scope="row" id="vendor_id">${vendorDetails.getVendor_id()}</td>
              <td class="text-center" id="vendor_name">${vendorDetails.getVendor_name()}</td>
              <td class="text-center" id="vendor_phone">${vendorDetails.getVendor_phone()}</td>
              <td class="text-center" id="vendor_email">${vendorDetails.getVendor_email()}</td>

              <td class="text-center" id="vendor_city">${vendorDetails.getVendor_city()}</td>
              <td class="text-center" id="vendor_state">${vendorDetails.getVendor_state()}</td>
              <td class="text-center" id="vendor_country">${vendorDetails.getVendor_country()}</td>
              <td class="text-center" id="vendor_zipcode">${vendorDetails.getVendor_zipcode()}</td>
              <td class="text-center" id="vendor_time_zone">${vendorDetails.getVendor_time_zone()}</td>

              <td class="text-center" id="edit">
                <a href="editVendorDetails/${vendorDetails.getVendor_id()}">
                  <span data-toggle="tooltip" title="Edit" class="glyphicon glyphicon-pencil" style="color:cornflowerblue;"></span>
                </a>
              </td>

              <td class="text-center" id="delete">
                <a href="deleteVendorDetails/${vendorDetails.getVendor_id()}">
                  <span data-toggle="tooltip" title="Delete" class="glyphicon glyphicon-remove" style="color:red;"></span>
                </a>
              </td>
            </tr>
          </c:forEach>  
