...
<body>
	...
	<div class="container" id="bodycont" style="margin-top: 50px">
		<f:form action="../saveUpdateVendorDetailsData" class="form"
			...
			<div class="row" style="align-items: center; display: flex">
				...
				<div class="col-xs-10" style="align-items: center; display: flex">
					<div class="input-group">
						...
						<f:input path="vendor_id" id="vendor_id" type="number"
			...
			<div class="row" style="align-items: center; display: flex">
				...
				<div class="col-xs-10">
					<div class="input-group">
						...
						<f:input path="vendor_name" id="vendor_name" type="text"
							class="form-control" name="vendor_name" />
					</div>
				</div>
			</div>
			<br>
			...
			<div class="row" style="align-items: center; display: flex">
				...
				<div class="col-xs-10">
					<div class="input-group">
						...
						<f:input path="vendor_zipcode" id="vendor_zipcode" type="text"
